...
import { Coffee, Wallet, HelpCircle, Home, Bus, BookOpen, Tv, Trash2 } from 'lucide-react';
...
const CATEGORY_MAP: Record<ExpenseCategory, { icon: React.FC<any>; color: string; bg: string }> = {
    ...
    rent_hostel:     { icon: Home,      color: '#8b5cf6', bg: 'rgba(139,92,246,0.12)' },
    travel:          { icon: Bus,       color: '#06b6d4', bg: 'rgba(6,182,212,0.12)'  },
    study_materials: { icon: BookOpen,  color: '#f472b6', bg: 'rgba(244,114,182,0.12)'},
    subscriptions:   { icon: Tv,        color: '#ec4899', bg: 'rgba(236,72,153,0.12)' },
    other:           { icon: HelpCircle, color: '#64748b', bg: 'rgba(100,116,139,0.1)' },
};
